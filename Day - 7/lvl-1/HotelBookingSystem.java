...
public class HotelBookingSystem {
    public static void main (String args[]){
        ...
        HotelBooking copiedBooking = new HotelBooking(hotelBookingObje);
        System.out.println(copiedBooking.getGuestName());
        System.out.println(copiedBooking.getRoomType());
        System.out.println(copiedBooking.getNights());
    } 
}